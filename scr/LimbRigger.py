...
class LimbRiggerWidget(QWidget):
    def __init__(self):
        ...
        def BuildIKControls(self,rootJnt,midJnt,endJnt):
            ...
            mel.eval(f"curve -d 1 -n {endCtrlName} #")         #CREATE POLYCUBE, MAKECURVETOOL, 
                                #GO TOO TOOL SETTINGS OF CURVE TOOL SET TO LINEAR
                                # FOLLOW EDGES OF CUBE,MAKE CURVE
                                # #CURVECOMMAND IN SCRIPT EDITOR,PASTE WHERE # IS
            ...
            #means the world space (ws) translation(t), of the root joint, returns them in x,y,z form
